Phase 0: snapshots + git + analysis
Phase 1: design system (in progress: mineral/saffron visual direction)
Phase 2: boot branding
Phase 3: login screen restyle + activation
Phase 4: fullscreen LukeShell
...
Phase 8: Luke App Store (complete: catalog, checksum-verified download, install/update/uninstall)
